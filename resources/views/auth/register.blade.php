...
<div class="register-box">
  <div class="card card-outline card-primary">
    <div class="card-header text-center">
      <a href="{{ asset('adminlte/index2.html') }}" class="h1"><b>Pengaduan</a>
    </div>
    <div class="card-body">
      ...
      <form action="{{ route('register-store') }}" method="POST">
        ...
        <div class="input-group mb-3">
          <input type="text" name="nama" value="{{ old('name') }}" required autocomplete="name" autofocus  class="form-control @error('name') is-invalid @enderror" placeholder="Nama Lengkap">
