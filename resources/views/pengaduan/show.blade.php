    ...
    <!-- form start -->
      <div class="card-body">
        <div class="form-group">
            ...
            <input type="text" name="tanggal" id="tanggal" value="{{ $pengaduans->user->id }}" disabled>
          </div>
          <div class="form-group">
        ...
        <div class="form-group">
            ...
            <textarea 
              ...
              id="isi_laporan" placeholder="isi_laporan" disabled>{{ $pengaduans->isi_laporan }}</textarea>
          </div>
          <div class="form-group" >
